...
#from gps data include coordinates here
    ...
    # using Haversine formula(spherical geometry) to calculate distance to goal
    # because gps data gives latitude and longitude ,so need spherical for calculations 
...
#        print("self.current_yaw", self.current_yaw)
    ...
    def get_angle_to_goal(self):
        ...
        self.angle_to_turn = self.current_yaw - angle_req*180/math.pi
    ...
    def move_to_goal(self):
        ...
        distance_travelled = np.sqrt((self.odom_self[1])**2 + (self.odom_self[0])**2)
